...
class Subscriber(DateTimeEntity):
    ...
    public_key = models.CharField("subscriber public-key", null=False, blank=False, max_length=255)
    auth_key = models.CharField("subscriber auth-key", null=False, blank=False, max_length=255)
